def add_food(nome='', descricao=''):
    if nome == '' or descricao == '':
        print('Você precisa passar o nome da comida + descrição')
    elif type(nome) is not str or type(descricao) is not str:
        print('Ambos os valores precisam ser uma string')
    elif nome in food_list:
        print(f'{nome} já está cadastrado no dicionário')
    else:
        food_list[nome] = str(descricao)
        print(f'{nome} cadastrado com sucesso!')


def delete_food(nome = ''):
  if nome == '':
    print('Você precisa passar o nome da comida para deletar')
  elif type(nome) is not str:
    print('O nome da comida precisa ser uma string')
  elif nome not in food_list:
    print(f'{nome} não existe no dicionário')
  else:
    del food_list[nome]
    print(f'{nome} deletado com sucesso!')


def update_food(nome = '', descricao = ''):
  if nome == '' or descricao == '':
    ...
    food_list[nome]=descricao
    print(f'{nome} descrição atualizado para {descricao}')

def get_food(nome = ''):
  if nome == '':
    print('Você precisa passar o nome da comida para consultar uma descrição')
  elif type(nome) is not str:
    print('O nome da comida precisa ser uma string')
  elif nome not in food_list:
    print(f'{nome} não existe no dicionário')
  elif nome in food_list:
    print(f'A descrição de {nome} é: {food_list[nome]}')
